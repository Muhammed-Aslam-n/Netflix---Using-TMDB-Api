...
class ScreenDetails extends StatelessWidget {
  const ScreenDetails({Key? key, this.name, this.description, this.bannerUrl,this.isAdult = false, this.year, this.cast ="Dulquer Salmaan,Sobhita Dhulipala,Tovino Thomas", this.creator ="Srinath Rajendran"}) : super(key: key);
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    commonText(text: "more", color: Colors.grey.shade500)
                  ],
                ),
              ),
              sizedh1,
